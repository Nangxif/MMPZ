                                ...
                                $.ajax({
                                    ...
                                    success: function (resData) {
                                        if(resData.logistics!="已签收") {
                                            t = $('<tr><td class="imgclas"><img src=\"' + resData.message.goodpicSrc + '\"/></td><td><p>' + resData.message.storeName + '</p><p>' + resData.message.goodName + '</p><p>' + '<i style="color: red">￥</i><span class="pri">' + resData.message.price + '</span></p></td><td class="num"><span>' + resData.num + '</span>件</td><td class="money">' + resData.message.price * resData.num + '元</td><td>' + resData.logistics + '</td></tr>')
                                            $("#pay-tab").append(t);
                                        }else{
                                            t = $('<tr><td class="imgclas"><img src=\"' + resData.message.goodpicSrc + '\"/></td><td><p>' + resData.message.storeName + '</p><p>' + resData.message.goodName + '</p><p>' + '<i style="color: red">￥</i><span class="pri">' + resData.message.price + '</span></p></td><td class="num"><span>' + resData.num + '</span>件</td><td class="money">' + resData.message.price * resData.num + '元</td><td>' +'<input type="button" class="btn" value="'+resData.logistics+'"  data-toggle="modal" data-target="#scoreModal"/></td></tr>');
                                            $("#pay-tab").append(t);
